...
Pain is a worldwide problem and affects all populations regardless of gender\fxnote{It's more likely to get chronic pain if one is female. See Macfalane}, age, income, ethnicity or geography, but the distribution across the globe differs. The prevalence and incidence is high despite the complexity of quantifying pain. It is estimated that 20\% of the world's populations adults suffer from pain and each year 10 \% is diagnosed with chronic pain~\cite{Goldberg2011}. 
