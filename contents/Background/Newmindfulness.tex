...
%****COMENTS FROM BO*****
% Meditation should be able to take the attention away from the emotional component of pain. Therefore meditation can reduce the brain process areas related to anticipation of pain, however it does not seem necessary that meditation reduce the brain process related with pain. \cite{Brown&Jones2010}
...
%****COMENTS FROM BO*****
% A study by Brown and Jones et al. \cite{Brow&Jones2010} showed that the greater the experience is with meditation the lower the perception of pain unpleasantness. This results in lower activation of the right inferior parietal cortex(IPC) and midcingulate cortex(MCC).
...
%****COMENTS FROM BO*****
%Pain as well as meditation alter sensory, cognitive and affective dimensions of subjective experience. Therefore brain areas activated during meditation and nociception should be interconnected in a way. \cite{ZeidanF2011}
...
%****COMENTS FROM BO*****
%A study by Gard et al. \cite{Gard2011} reported that the brain pattern related with pain modulation during mindfulness differs to other pain coping strategies. An increased activation in the rostral anterior cingulate cortex (rACC) and the ventromedial PFC (vmPFC) in the anticipaton of pain stage was found for mindfulness practicioners. The activation of this areas has been identify with positive emotions.

%A study by Gard et al. \cite{Gard2011} found for mindfulness practicioners an increased activation in the rACC/vmPFC while anticipating pain. As well as decreased activation in the bilateral IPFC and increased activation in the posterior insula/S2 when receiving  a stimuli.
%A study by Grant et al.\cite{Grant2011} showed that mindfulness practicioners have different neuronal responses to painful stimuli with a greater activation in the insula and thalamus and a decrease in PFC.
...
\begin{itemize}
	...
	%****COMENT FROM BO*****
	% It has been shown in several studies an increased activation in PFC during minfulness meditation as well as in rest after the practice.
