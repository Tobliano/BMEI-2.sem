...
There was no significant difference between the threshold and tolerance before and after. To test the normality of the difference between threshold and tolerance a Shapiro-Wilk test ($\alpha$ > 0.05) has been used. The result from the test is illustrated in \tabref{tab:ShapiroWilk2}.
...
A normal distribution was seen for the difference in threshold and tolerance for the treatment group and control group, why a T-test ($\alpha$ < 0.05) was used to test if there was a difference between the groups. 
