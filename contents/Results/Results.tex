...
\begin{longtable} {l|c|c}
	\caption{Relative difference in Threshold and Tolerance with associated standard deviation for treatment and control group.}
	\label{tab:Total} \\
\cellcolor[HTML]{C0C0C0}{} &
...
A bar plot of the relative difference is illustrated in \figref{fig:barplot}. The bars show the increase in Threshold and Tolerance as a percentage for treatment and control group.
...
The dataset was normal distributed, indicated in \tabref{tab:ShapiroWilk1}, and had an equal variance, indicated in \tabref{tab:Levene1}. Hence a two-way mixed ANOVA ($\alpha$ < 0.05) was used to test if there is a difference within and between treatment and control group. Hereby Pre and Post measurement of Threshold and Tolerance were compared to assess the within-subjects effect. Treatment and control group were compared to assess the between-subjects effect. Results from the two-way mixed ANOVA are illustrated in \tabref{tab:ANOVA1} for Threshold and \tabref{tab:ANOVA2} for Tolerance. 
...
The test indicates that there is a significant main effect between Pre and Post of Tolerance measurements (within-subject effect, Measurement), F(1,30) = 8.981, p = 0.006. However, no significant main effect is seen between treatment and control group for Tolerance (between-subjects effect, Group), F(1,30) = 3.289, p = 0.080, nor a significant main interaction between  measurements and group (within-subjects effect, Measurement x Group), F(1,30) = 0.532, p = 0.472. 

\section{T-test}
The Shapiro-Wilk test showed a normal distribution for relative difference in Threshold and Tolerance for treatment and control group, indicated in \tabref{tab:ShapiroWilk2}. Furthermore the Levene's test showed an unequal variance for Threshold and an equal variance for Tolerance, indicated in \tabref{tab:Levene2}.
Thus a t-test ($\alpha$ < 0.05) was used to test if there was a difference between treatment and control group. Results from this test are illustrated in \tabref{tab:T-test1}.
