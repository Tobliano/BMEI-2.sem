...
\caption{Threshold and tolerance pre and post and the percentage difference between these values for the treatment group. The asterisk indicates that the tolerance is not representative.}
\label{tab:Treatment}
\end{longtable}
\vspace{-.5cm}
