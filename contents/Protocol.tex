...
The same measurement routine was conducted six times, three times on the left upper trapezius and three times on the right upper trapezius. Each measurement was notated and an average of each side was used for the pain threshold and pain tolerance respectively. To avoid oversensation, the two sides were measured alternately with 1 minute pause in between, so the subjects had a resting time between the measurements on the same side.  
