...
\begin{longtable}{l|c|c|c}
	\caption{Subject characteristics for treatment group. Gender is indicated with either female (F) or male (M). The mean and standard deviation are calculated for age and BMI.}
	\label{tab:subjectsA} \\
